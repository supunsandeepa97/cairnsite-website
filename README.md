...
The official one-page marketing site for **Cairnsite** — we design real websites for local
businesses worldwide, show a working sample first, then host and maintain it.

- **Single static page:** `index.html` (self-contained: inline CSS + inline SVG, system fonts, no build step).
